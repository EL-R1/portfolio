...
const translations: TranslationsSet = {
  fr: {
    ...
    cvNavLabel: 'CV',
    cvDownloadPdf: 'Télécharger en PDF',
    cvDownloadDocx: 'Télécharger en Word (.docx)',
    cvDownloadMd: 'Télécharger le Markdown',
    personalProjects: 'Projets Personnels',
    concepts: 'Concepts Personnels',
    ...
    aboutText: "Développeur Full Stack depuis 4 ans, j'ai pu concevoir, mettre en place et réfléchir sur des projets de A à Z, mais aussi participer à l'amélioration de projets existants. Je suis passionné par la recherche d'informations en tout genre.",
    interest1: 'Cybersécurité (2040 pts Root-Me, CTF)',
  ...
  en: {
    ...
    cvDownloadDocx: 'Download Word (.docx)',
    cvDownloadMd: 'Download Markdown',
    ...
    aboutText: "Full Stack Developer for 4 years, I have designed, implemented, and strategized projects from A to Z, while also contributing to the improvement of existing projects. I am passionate about researching all kinds of information.",
    interest1: 'Cybersecurity (2040 pts Root-Me, CTF)',
