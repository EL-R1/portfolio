...
const translations: TranslationsSet = {
  fr: {
    ...
    aboutText: "Concepteur et développeur d'applications depuis 4 ans, j'ai pu concevoir, mettre en place et réfléchir sur des projets de A à Z, mais aussi participer à l'amélioration de projets existants. Je suis passionné par la recherche d'informations en tout genre.",
  ...
  en: {
    ...
    aboutText: "Application designer and developer for 4 years, I have designed, implemented, and strategized projects from A to Z, while also contributing to the improvement of existing projects. I am passionate about researching all kinds of information.",
